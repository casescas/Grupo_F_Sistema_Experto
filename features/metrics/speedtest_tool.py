...
#Clase encargada de medir y almacenar la velocidad de conexiÃ³n a Internet
class SpeedTestConexion:
    ...
    #se realiza la mediciÃ³n de velocidad y ping.
    def medir(self):
        try:
            #Usamos la librerÃ­a speedtest para medir la velocidad y ping.
